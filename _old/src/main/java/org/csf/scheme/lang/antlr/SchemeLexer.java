// $ANTLR 3.5.2 src/main/antlr3/Scheme.g 2014-10-13 15:16:54
...
public class SchemeLexer extends Lexer {
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/antlr3/Scheme.g:58:8: ( ( SIGN )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? ( ( 'e' | 'E' ) ( SIGN )? ( '0' .. '9' )+ )? )
			// src/main/antlr3/Scheme.g:58:10: ( SIGN )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? ( ( 'e' | 'E' ) ( SIGN )? ( '0' .. '9' )+ )?
			{
			// src/main/antlr3/Scheme.g:58:10: ( SIGN )?
			int alt1=2;
			...
			// src/main/antlr3/Scheme.g:58:16: ( '0' .. '9' )+
			int cnt2=0;
			loop2:
			while (true) {
				int alt2=2;
			...
			// src/main/antlr3/Scheme.g:58:28: ( '.' ( '0' .. '9' )+ )?
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					// src/main/antlr3/Scheme.g:58:29: '.' ( '0' .. '9' )+
					{
					match('.'); 
					// src/main/antlr3/Scheme.g:58:33: ( '0' .. '9' )+
					int cnt3=0;
					loop3:
					while (true) {
						int alt3=2;
			...
			// src/main/antlr3/Scheme.g:58:47: ( ( 'e' | 'E' ) ( SIGN )? ( '0' .. '9' )+ )?
			int alt7=2;
			...
			switch (alt7) {
				case 1 :
					// src/main/antlr3/Scheme.g:58:48: ( 'e' | 'E' ) ( SIGN )? ( '0' .. '9' )+
					{
					...
					// src/main/antlr3/Scheme.g:58:60: ( SIGN )?
					int alt5=2;
					...
					// src/main/antlr3/Scheme.g:58:66: ( '0' .. '9' )+
					int cnt6=0;
					loop6:
					while (true) {
						int alt6=2;
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/antlr3/Scheme.g:60:4: ( SYMBOL_HEAD ( SYMBOL_REST )* )
			// src/main/antlr3/Scheme.g:60:6: SYMBOL_HEAD ( SYMBOL_REST )*
			{
			mSYMBOL_HEAD(); 

			// src/main/antlr3/Scheme.g:60:18: ( SYMBOL_REST )*
			loop8:
			while (true) {
				int alt8=2;
	...
	public final void mSYMBOL_HEAD() throws RecognitionException {
		try {
			// src/main/antlr3/Scheme.g:65:5: ( SIGN | 'a' .. 'z' | 'A' .. 'Z' | '*' | '!' | '_' | '?' | '>' | '<' | '=' | '$' | '&' )
			// src/main/antlr3/Scheme.g:
			{
	...
	public final void mSYMBOL_REST() throws RecognitionException {
		try {
			// src/main/antlr3/Scheme.g:69:5: ( SYMBOL_HEAD | '0' .. '9' | '.' )
			// src/main/antlr3/Scheme.g:
			{
			if ( input.LA(1)=='!'||input.LA(1)=='$'||input.LA(1)=='&'||(input.LA(1) >= '*' && input.LA(1) <= '+')||(input.LA(1) >= '-' && input.LA(1) <= '.')||(input.LA(1) >= '0' && input.LA(1) <= '9')||(input.LA(1) >= '<' && input.LA(1) <= '?')||(input.LA(1) >= 'A' && input.LA(1) <= 'Z')||input.LA(1)=='_'||(input.LA(1) >= 'a' && input.LA(1) <= 'z') ) {
				input.consume();
	...
	public final void mBOOLEAN() throws RecognitionException {
		try {
			int _type = BOOLEAN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/antlr3/Scheme.g:73:9: ( '#t' | '#f' )
			int alt9=2;
			...
			switch (alt9) {
				case 1 :
					// src/main/antlr3/Scheme.g:73:11: '#t'
					{
					match("#t"); 
					...
					break;
				case 2 :
					// src/main/antlr3/Scheme.g:73:18: '#f'
					{
					match("#f"); 
	...
	public final void mCHAR() throws RecognitionException {
		try {
			int _type = CHAR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/antlr3/Scheme.g:75:6: ( '\\'' . '\\'' )
			// src/main/antlr3/Scheme.g:75:8: '\\'' . '\\''
			{
			match('\''); 
			matchAny(); 
			match('\''); 
	...
	public final void mSTRING() throws RecognitionException {
		try {
			int _type = STRING;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// src/main/antlr3/Scheme.g:77:8: ( '\\\"' ( . )* '\\\"' )
			// src/main/antlr3/Scheme.g:77:10: '\\\"' ( . )* '\\\"'
			{
			match('\"'); 
			// src/main/antlr3/Scheme.g:77:15: ( . )*
			loop10:
			while (true) {
				int alt10=2;
	...
	public void mTokens() throws RecognitionException {
		// src/main/antlr3/Scheme.g:1:8: ( NIL | T__19 | T__20 | T__21 | T__22 | WS | NUMBER | ID | BOOLEAN | CHAR | STRING )
		int alt11=11;
		...
		switch (alt11) {
			case 1 :
				...
				break;
			case 2 :
				// src/main/antlr3/Scheme.g:1:14: T__19
				{
				mT__19(); 
				...
				break;
			case 3 :
				// src/main/antlr3/Scheme.g:1:20: T__20
				{
				mT__20(); 
				...
				break;
			case 4 :
				// src/main/antlr3/Scheme.g:1:26: T__21
				{
				mT__21(); 
				...
				break;
			case 5 :
				// src/main/antlr3/Scheme.g:1:32: T__22
				{
				mT__22(); 
			...
			case 8 :
				...
				break;
			case 9 :
				// src/main/antlr3/Scheme.g:1:51: BOOLEAN
				{
				mBOOLEAN(); 
				...
				break;
			case 10 :
				// src/main/antlr3/Scheme.g:1:59: CHAR
				{
				mCHAR(); 
				...
				break;
			case 11 :
				// src/main/antlr3/Scheme.g:1:64: STRING
				{
				mSTRING(); 
