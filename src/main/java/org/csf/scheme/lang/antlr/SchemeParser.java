...
public class SchemeParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "PROGRAM", "EXPRESSION", "LIST", "LITERAL", "NUMBER", "ID", 
		"BOOLEAN", "CHAR", "STRING", "'nil'", "WS", "COMMENT"
	};
	public static final int
		RULE_file = 0;
	...
	public static class FileContext extends ParserRuleContext {
		public TerminalNode PROGRAM() { return getToken(SchemeParser.PROGRAM, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SchemeListener ) ((SchemeListener)listener).enterFile(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SchemeListener ) ((SchemeListener)listener).exitFile(this);
		}
	}
